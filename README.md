...
This is a sample template for lambda-podbooster - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name lambda-podbooster --query 'Stacks[].Outputs'
```
